...
def class_text_to_int(row_label):
    print('********',row_label)
    if row_label == 'cat':    # 使用图片标注的label csv文件
        return 1
    else:
        return 2
...
def main(_):
    ...
    path = os.path.join(os.getcwd(), 'E:/detect_demo/train')   #图片文件路径
...
# dos命令
# python csv_to_record.py --csv_input=dogcat.csv --output_path=dogcat.record
